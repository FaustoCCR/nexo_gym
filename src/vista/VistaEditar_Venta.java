...
public class VistaEditar_Venta extends javax.swing.JInternalFrame {

    public VistaEditar_Venta() {
        initComponents();
    }
    ...
    public JButton getBt_actualizarventa() {
        return bt_actualizarventa;
    }

    public void setBt_actualizarventa(JButton bt_actualizarventa) {
        this.bt_actualizarventa = bt_actualizarventa;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaEditar_Venta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaEditar_Venta().setVisible(true);
            }
        });
    }
