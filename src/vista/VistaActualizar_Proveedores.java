...
public class VistaActualizar_Proveedores extends javax.swing.JInternalFrame{

  
    public VistaActualizar_Proveedores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaActualizar_Proveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaActualizar_Proveedores().setVisible(true);
            }
        });
    }
