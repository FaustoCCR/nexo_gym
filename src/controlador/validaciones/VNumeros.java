...
public class VNumeros extends KeyAdapter {
    ...
    public VNumeros(JTextField txt, int lenght) {
        this.txt = txt;
        this.lenght = lenght;
    }
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if ((!Validar.esNumeros(car + "") && car != e.VK_ENTER && car != e.VK_BACK_SPACE) || txt.getText().length() >= lenght) {
            e.consume();
